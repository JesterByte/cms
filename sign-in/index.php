...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>Signin · Green Haven Memorial Park</title>
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
    <?php include_once "../components/theme.html"; ?>

    
    <main class="form-signin w-100 m-auto">
      <form class="needs-validation" novalidate action="../process/process-sign-in.php" method="post">
        <img class="mb-4" src="../assets/brand/green_haven_memorial_park_logo.png" alt="" width="300" height="150">
